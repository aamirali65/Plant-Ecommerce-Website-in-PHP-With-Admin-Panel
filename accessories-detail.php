                    ...
                    <div class="row h-100">
                        <div class="col-lg-12">
                            <div class="breadcrumb-item">
                                <h2 class="breadcrumb-heading"><?php echo $row['name']?></h2>
                                <ul>
                                    <li>
                    ...
                    <div class="row">
                                ...
                                <div class="swiper-container single-product-slider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="<?php echo "./admin/img/accessories/".$row['img']?>" class="single-img gallery-popup">
                                                <img class="img-full" src="<?php echo "./admin/img/accessories/".$row['img']?>" alt="Product Image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 pt-5 pt-lg-0">
                            <div class="single-product-content">
                                ...
                                <p class="short-desc"><?php echo $row['purpose']?></p>
...
<?php }} ?>
            ...
            <div class="product-area section-space-y-axis-90">
                <div class="container">
                    ...
                    <?php
                    include('config.php');
                    $query2 = mysqli_query($con , "SELECT * FROM `accessories` ORDER BY RAND() LIMIT 4");
                    if($query2){
                    ...
                    <div class="swiper-slide product-item">
                        ...
                        <div class="product-content">
                            <a class="product-name" href="product-detail.php?id=<?php echo $row2['id']?>"><?php echo $row2['name']?></a>
