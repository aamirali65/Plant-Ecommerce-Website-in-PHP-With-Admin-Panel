                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
                                    ...
                                    <?php
                                    include('config.php');
                                    $query = mysqli_query($con,"select * from accessories order by id desc");
                                    if($query){
                                            ...
                                            <div class="product-item">
                                                <div class="product-img">
                                                    <a href="product-detail.php?id=<?php echo $row['id']?>">
                                                        <img class="primary-img" src="<?php echo "./admin/img/accessories/".$row['img']?>" alt="Product Images">
                                                ...
                                                <div class="product-content">
                                                    <a class="product-name" href="single-product-variable.html"><?php echo $row['name']?></a>
