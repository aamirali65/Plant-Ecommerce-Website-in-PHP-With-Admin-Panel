            ...
            <div class="header-top bg-pronia-primary d-none d-lg-block">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="header-top-right align-items-center login">
                                <?php 
                                session_start();
                                if(isset($_SESSION['name']) != NULL ){
                                    echo '<span class="pronia-offer">HELLO ' . $_SESSION['name'] . '! WELCOME BACK</span>';
                                }else{
                                    echo '<a class="pronia-offer" href="login.php">Login /</a>';
                                        ...
                                        <li class="dropdown d-none d-lg-block">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="settingButton">
                                                <?php  if(isset($_SESSION['name']) != NULL ){
                                                    echo ' <li><a class="dropdown-item" href="my-account.php">My Account</a></li>';
                                                }else{
                                                    echo '<li><a class="dropdown-item" href="login.php">Login</a>';
